...
public class Contact extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_1=(Button)view.findViewById(R.id.btn_website);
        btn_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a=new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.tmc.edu.sg/"));
                startActivity(a);
            }
        });

        btn_2=(Button)view.findViewById(R.id.btn_call);
        btn_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b=new Intent(Intent.ACTION_DIAL);
                b.setData(Uri.parse("tel:+65 66909599"));
                startActivity(b);
            }
        });

        btn_3=(Button)view.findViewById(R.id.btn_email);
        btn_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent c=new Intent(Intent.ACTION_VIEW);
                c.setData(Uri.parse("mailto:info@tmc.edu.sg"));
                startActivity(c);
            }
        });

        btn_4=(Button)view.findViewById(R.id.btn_location);
        btn_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent d=new Intent(Intent.ACTION_VIEW);
                d.setData(Uri.parse("geo:1.301373,103.850672"));
                startActivity(d);
            }
        });
        return view;
